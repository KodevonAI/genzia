...
- [x] 05-04-PLAN.md — Tools del agente: create_client, update_client, list_clients, get_client + registro (CLI-01, CLI-03, CLI-04)
- [x] 05-05-PLAN.md — Namespace i18n Clients completo + lista/búsqueda web + link de nav (CLI-04, CLI-05)
...
- [x] 05-10-PLAN.md — [BLOCKING] aplicar migraciones 0020-0022 a Neon real, correr las 6 suites y verificación humana de dictado + ficha (checkpoint, requiere red)
